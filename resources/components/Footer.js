...
const Footer = () => {
  ...
  return (<Flex 
    ...
    color={iconColor} 
    >
        <IconButton  variant='ghost' fontSize='25px' icon={<FaHome />} />
        <IconButton   variant='ghost' fontSize='25px' icon={<FaUser />} onClick={() => {}}/>
        ...
        <IconButton   variant='ghost' fontSize='25px' icon={<FaShoppingCart />} />
    </Flex>);
};
